...
void CObjectSpawnPoint::Spawn()
{
    ...
    case EObjectSpawnType::Bullet:
        mSpawnObject = mScene->CreateObj<CBallObject>("Bullet");
        break;
    ...
    case EObjectSpawnType::TornadoBullet:
        ...
        break;
    case EObjectSpawnType::NormalBrick:
        mSpawnObject = mScene->CreateObj<CNormalBrick>("NormalBrick");
        break;
    case EObjectSpawnType::ItemBrick:
        mSpawnObject = mScene->CreateObj<CItemBrick>("ItemBrick");
        break;
    }
