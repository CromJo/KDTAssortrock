...
void CPlayerObject::Skill6(float DeltaTime)
{
    /*
        자기장 스킬
        1. 총알을 쏘고 일정거리 이동 후 멈춤
        2. 3초 동안 총알의 특정 범위안에 들어오는 몬스터를 당겨오기
            2-1. 특정시간에 걸쳐서 몬스터를 당겨오기
    */
    CPullBullet* Bullet = mScene->CreateObj<CPullBullet>("Bullet");
